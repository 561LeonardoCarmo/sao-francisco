...
export default function HomePage() {
  const brothers = [
    ...
    { name: 'Kauã Gabriel', role: 'Pastoreio', image: '/avatar-male.jpg' },
    { name: 'Kauã Souza', role: 'Liturgia', image: '/avatar-male.jpg' },
    { name: 'Laura', role: 'Comunicação', image: '/avatar-male.jpg' },
    { name: 'Letícia', role: 'Pastoreio', image: '/avatar-male.jpg' },
    { name: 'Luis', role: 'Comunicação', image: '/avatar-male.jpg' },
    { name: 'Luis Fernando', role: 'Coord. Irradiação', image: '/avatar-male.jpg' },
